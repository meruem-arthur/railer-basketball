...
// These small inline SVGs replace them. Shared here so every place that
// needs a social icon (footer, contact page, admin, etc.) imports from
// one spot instead of redefining them.
